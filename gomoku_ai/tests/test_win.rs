...
fn test_horizon2() {
    ...
    player1.add_new_point(point1, &mut matrix, &mut test);
    player1.add_new_point(point2, &mut matrix, &mut test);
    player1.add_new_point(point4, &mut matrix, &mut test);
    player1.add_new_point(point5, &mut matrix, &mut test);
...
fn test_horizon3() {
    ...
    player1.add_new_point(point1, &mut matrix, &mut test);
    player1.add_new_point(point2, &mut matrix, &mut test);
    player1.add_new_point(point3, &mut matrix, &mut test);
    player1.add_new_point(point4, &mut matrix, &mut test);
